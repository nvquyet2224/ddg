    ...
    var Slider = {
        ...
        checkPagination : function () {
            ...
            base.paginationWrapper.find(".slide-page").each(function () {
                if ($(this).data("roundpages") === $(base.$BTQItems[base.currentItem]).data("roundpages")) {
        ...
        lazyLoad : function () {
            ...
            for (i = 0; i < base.itemsAmount; i += 1) {
                ...
                if ($item.data("slide-loaded") === undefined) {
                    $lazyImg.hide();
					$item.append('<div class="preloader"></div>');
        ...
        lazyPreload : function ($item, $lazyImg) {
            ...
            function showImage() {
				...
				$item.data("slide-loaded", "loaded").children().addClass("done")
				$item.find('.preloader').hide();
    ...
    var Swiper = function (container, params) {
        ...
        s.zoom = {
            ...
            onGestureStart: function (e) {
                ...
                z.isScaling = true;
				 $('.close-album, .slide-pic-nav').addClass('level-index-out');
            },
            ...
            toggleZoom: function (s, e) {
                ...
                if (z.scale && z.scale !== 1) {
					...
					z.gesture.image.removeClass('zoomin');
					z.gesture.image.parent().removeClass('zoomin');
					$('.close-album, .slide-pic-nav').removeClass('level-index-out');
                }
                else {
                    // Zoom In
                    z.scale = z.currentScale = z.gesture.imageWrap.attr('data-zoom') || s.params.zoomMax;
					z.gesture.image.addClass('zoomin');
					z.gesture.image.parent().addClass('zoomin');
					$('.close-album, .slide-pic-nav').addClass('level-index-out');
            ...
            attachEvents: function (detach) {
                ...
                if (s.params.zoom) {
                   ...
                   if (s.params.zoomToggle) {
						...
						if(isDesktop || $(window).width() > 1100){
						      s.on('click', s.zoom.toggleZoom);
